...
本資料夾定義 v6 workflow engine 的**執行時期行為**，是 [v6/dsl-spec](../dsl-spec/) 的對應實作規格。
...
| [02-instance-lifecycle](02-instance-lifecycle.md) | Workflow / function instance 的狀態機與持久化 |
| [03-step-execution](03-step-execution.md) | 各 step type 的執行語意（task / wait / foreach / parallel / saga / callback ...） |
| [04-expression-evaluation](04-expression-evaluation.md) | CEL 求值器、namespace 解析、求值時機 |
| [05-task-registry](05-task-registry.md) | Action 名稱解析、tool / function 的註冊與查找 |
...
3. **協議優先**：tool 介面為協議邊界，引擎內部資料結構不外洩；所有外部互動透過 schema 化的訊息。

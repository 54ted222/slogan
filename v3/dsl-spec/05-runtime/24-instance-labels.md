...
當 workflow 透過 `renew` 執行 continue-as-new（詳見 [10-step-terminal](../02-steps/10-step-terminal.md)）時，預設繼承原 instance 的所有 labels：
...
- [06-step-task](../02-steps/06-step-task.md) — builtin task `instance.set_labels`、`instance.remove_labels`
- [10-step-terminal](../02-steps/10-step-terminal.md) — continue-as-new 與 `inherit_labels`
- [02-document-structure](../01-core/02-document-structure.md) — Workflow 頂層結構

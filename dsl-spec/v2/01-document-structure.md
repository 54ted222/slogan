...
本文件定義 workflow definition 的頂層 YAML 結構。
...
| 欄位 | 型別 | 必填 | 說明 |
|------|------|------|------|
| `apiVersion` | string | MUST | 固定值 `workflow/v2` |
...
| `secrets` | array | workflow 依賴的 secret 名稱列表（見 [18-secrets-and-env](18-secrets-and-env.md)） |

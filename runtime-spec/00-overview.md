...
| **Task Executor** | 執行 task backend：stdio / http / builtin 三種協定 | [05-task-executor](05-task-executor.md) |
...
| [10-concurrency-control](10-concurrency-control.md) | 全域並發控制、rate limiting、backpressure |
| [11-observability](11-observability.md) | Metrics、tracing、health check、resource tracking |
| [12-authentication](12-authentication.md) | Authentication & Authorization（API key、RBAC） |
